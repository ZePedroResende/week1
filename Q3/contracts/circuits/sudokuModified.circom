...
template sudoku() {
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
          rangeCheck[i][j][0]= RangeProof(4);
          rangeCheck[i][j][1]= RangeProof(4);
        }
    }
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            rangeCheck[i][j][0].range[0] <== 10;
            rangeCheck[i][j][0].range[1] <== 0;

            rangeCheck[i][j][0].out === 1;

            rangeCheck[i][j][1].in <== solution[i][j];
            rangeCheck[i][j][1].range[0] <== 10;
            rangeCheck[i][j][1].range[1] <== 0;
